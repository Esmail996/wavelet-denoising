...
import numpy as np
import pandas as pd
from TOF_estimation import SOUND_SPEED_M_S, FS_HZ, CARRIERS_HZ
from calibration import tof_to_distance_calibrated

csv_path = Path('outputs/tof_matched/multifrequenz_denoised_branchA_sym6_peaks.csv')
...
#python tof/investigate_residual_bias.py