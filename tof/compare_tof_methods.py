...
Uses the calibrated distance columns from the separate calibration output.
"""
import pandas as pd
import numpy as np
from pathlib import Path

csv_path = Path("outputs/tof_matched/multifrequenz_denoised_branchA_sym6_calibrated.csv")
